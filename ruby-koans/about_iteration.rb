...
class AboutIteration < Neo::Koan
  ...
  # Because open with take the block given by do and sandwich it in
  # between an open and ensure its closing. By doing it the second
  # way, we have to explicitly handle the closing which is not perfect.
